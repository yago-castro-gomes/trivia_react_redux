export const DATA_TEST_INPUT_NAME = 'input-player-name';
export const DATA_TEST_INPUT_EMAIL = 'input-gravatar-email';
export const DATA_TEST_BTN_PLAY = 'btn-play';
export const DATA_TEST_BTN_SETTINGS = 'btn-settings';

export const PLAYER_NAME = 'Nome da pessoa'
export const PLAYER_EMAIL = 'grupo19@email.com'
